...
#Histograma
intervalos = range(math.floor(min(muestra)), math.ceil(max(muestra)) + 2) #calculamos los extremos de los intervalos
plt.hist(x=muestra, bins=intervalos, color='#F2AB6D', rwidth=0.85)
